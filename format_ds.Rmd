...
phyloseq_object <- file.path(path, "phyloseq.rds", fsep="/")
asv_oral <- file.path(path, "asv_table_genus_oral.csv", fsep="/")
taxa_oral <- file.path(path, "taxa_table_genus_oral.csv", fsep="/")
asv_rectal <- file.path(path, "asv_table_genus_rectal.csv", fsep="/")
taxa_rectal <- file.path(path, "taxa_table_genus_rectal.csv", fsep="/")
```
